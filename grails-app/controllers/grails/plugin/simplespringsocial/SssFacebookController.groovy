...
class SssFacebookController {
	...
	def connected = {
		...
		def redirectController = grailsApplication.config.grails.plugin.simplespringsocial.facebook.loginSuccess.controller
		def redirectAction = grailsApplication.config.grails.plugin.simplespringsocial.facebook.loginSuccess.action
