package org.o14x.simplespringsocial.facebook.config
...
class FacebookSpringConfig {
	...
	ConnectionFactory facebookConnectionFactory() {
		...
		String clientId = ConfigurationHolder.config.grails.plugins.simplespringsocial.facebook.clientId
		String clientSecret = ConfigurationHolder.config.grails.plugins.simplespringsocial.facebook.clientSecret

		// checks the parameters
		assert clientId, "You must configure the Facebook clientId into Config.groovy with the following parameter : grails.plugins.simplespringsocial.facebook.clientId"
		assert clientSecret, "You must configure the Facebook clientId into Config.groovy with the following parameter : grails.plugins.simplespringsocial.facebook.clientSecret"
